<!-- Main modal -->
<div id="konfirmasi" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow :bg-gray-700">
            ...
            <div class="w-full flex flex-col gap-5 p-3">
                ...
                <button data-modal-target="tambah" data-modal-toggle="tambah"
                    class="bg-blue-500  py-6 rounded-md text-white min-w-full">Tambah Stok buku</button>
                @if ($bukuGalih->stok > 0)
                    <button data-modal-target="kurang" data-modal-toggle="kurang"
                        class="bg-red-500 py-6 rounded-md text-white min-w-full">Pengurangan Stok buku</button>
                @endif
